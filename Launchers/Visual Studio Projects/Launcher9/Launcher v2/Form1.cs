...
namespace Launcher
{
    public partial class Form1 : Form
    {
        ...
        public string ServerUpdate = "http://earlydekaron.net/update/"; // server url
        ...
        private void backgroundWorker1_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            if (File.Exists(Root + "EarlyLauncher_new.exe"))
            {
                downloadLbl.Text = "New Launcher found...";

                MessageBox.Show("New Launcher found!" + "\n" + "The launcher will now close and update.","New Launcher Update",MessageBoxButtons.OK,MessageBoxIcon.Asterisk);
            ...
            downloadLbl.Text = "Client is updated! Press START to play!";
        }
        ...
        private void strtGameBtn_Click_1(object sender, EventArgs e)
        {
            ...
            {               
                Process.Start(Root + "\\bin\\dekaron.exe");
                System.Environment.Exit(1); ;
            }
        }
        private void pictureBox1_Click(object sender, EventArgs e) // Facebook
        {
            Process.Start("http://earlydekaron.net/");
        }
        private void pictureBox4_Click(object sender, EventArgs e) // Vote
        {
            Process.Start("http://earlydekaron.net/");
        }
        ...
        private void button1_Click(object sender, EventArgs e) // Website
        {
            Process.Start("http://earlydekaron.net/");
        }
        ...
        private void button3_Click(object sender, EventArgs e) // Forum
        {
            Process.Start("http://earlydekaron.net/");
        }
        private void button4_Click(object sender, EventArgs e) // Support
        {
            Process.Start("http://earlydekaron.net/");
        }
        ...
        private void CheckForRemoteMessage()
        {
            ...
            {
                debug("Remote message NOT found");
            }
        ...
        private void RunRss()
        {
            // RUN RSS
            lstNews.Items.Clear();
            rssReader = new XmlTextReader("http://earlydekaron.net/update/news.xml");
