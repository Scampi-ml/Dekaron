...
if($is_gm != '0') {
	...
	if($_GET['sid'] == 'list') {
		...
		echo "<br><table class='innertab'>
			<tr>
				<td colspan='2' align='left'><b><u>".$language['head2']."</b></u></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td align='left'>".$language['split2']."</td></tr>";
		...
		if(empty($_POST['select'])) {
			...
			echo "<center><br><form action='?function=banacc&sid=ban&uc=".$uc."' method='POST'>
				<table class='innertab'>
					<tr>
						<td colspan='2' align='left'><b><u>".$language['head3']."</b></u></td>
					</tr>
					<tr>
						<td colspan='2' align='left'>&nbsp;</td>
					</tr>
					...
					<tr>
						<td align='left' colspan='2'><b>".$language['split3']."</b></td>
					</tr>
					<tr>
						<td align='left'>".$language['split4']."</td>
					...
					<tr>
						<td align='left'>".$language['split5']."</td>
