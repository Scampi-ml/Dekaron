...
if($_POST['log'] == 'login' && $count1 == '0') {
	$error = '<br>This game account is unfortunately not known to us.<br><br><a href="../usercp.php" target="_self">Back</a>';
}
elseif($_POST['log'] == 'login' && $row2[0] != $crypt_accpass) {
	$error = '<br>Game account password this is unfortunately wrong.<br><br><a href="../usercp.php" target="_self">Back</a>';
}
elseif($_POST['log'] != 'login' && $count1 == '0') {
	$error = '<br>Please Log in again.<br><br><a href="../usercp.php" target="_self">Back</a>';
}
elseif($_POST['log'] != 'login' && $row2[0] < $again) {
	$error = '<br>You were inactive for too long. Please log in again.<br><br><a href="../usercp.php" target="_self">Back</a>';
}
elseif($_POST['log'] != 'login' && $row2[1] != $ip) {
	$error = '<br>You searched in the time between your Internet connection had lost. Please log in again.<br><br><a href="../usercp.php" target="_self">Back</a>';
}
else {
