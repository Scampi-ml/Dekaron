...
<div align="center">
  ...
  <span class="STYLE1">查询可以升到的等级和经验值</span></div>
...
<?php } else {
  if ( empty ( $_POST[Character_name] ) ) { 
    die ( "<p><b>username cannot be empty!</b></p>" );
  }
  if ( empty ( $_POST[Money])) {
    die ("<p><b>Money ammount cannot be empty!</b></p>");}
	...
	if ( $character_no== null) { die ( "<p><b>no player!</b></p>" );} 
...
<table width="324" border="1" align="center" cellpadding="3" id="showTable">
  ...
  <tr>
    ...
    <td><?php echo $exp1; ?></td>
      ...
      <tr>
    <td colspan="2"><div align="center"><a href="index.html">Back to index</a></div></td>
  </tr>
</table>
<?php } ?>
</body>
