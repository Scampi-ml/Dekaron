	...
	if(empty($_POST['select'])) {
		echo "<center><br><form action='?function=character&uc=".$uc."' method='POST'>
			<table class='innertab'>
				<tr>
					<td colspan='2' align='left'><img src='images/content/content_modify_char.png' valign='left'></td>
				</tr>
				<tr>
		...
		if($count1 < '1') {
			...
			echo "<center><br><form action='?function=character&uc=".$uc."' method='POST'>
				<table class='innertab'>
					<tr>
						<td colspan='3' align='left'><img src='images/content/content_modify_char.png' valign='left'></td>
					</tr>
					<tr>
