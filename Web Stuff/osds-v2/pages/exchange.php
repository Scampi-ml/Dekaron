...
if(empty($_POST['select'])) {
	echo "<center><form action='?do=exchange&id=".$id."' method='POST'>
		<table class='innertab'>
			<tr>
				<td colspan='2' align='center'><img src='images/content/content_your_coins.png' valign='left'><br></td>
			</tr>
			<tr>
			...
			<tr>
				<td align='center'>How many coins do you want?</td>
	...
	if($row1[0] == '1100') {
		echo "<br>You are currently online, so unfortunately you can not exchange coins.<br><a href='javascript:history.back()'>Go Back</a>";
	} elseif(!preg_match("/[0-9]?/",$_POST['curcoins'])) {
		echo "<br>Please enter only numbers in the total coins which you want to exchange.<br><a href='javascript:history.back()'>Go Back</a>";
	} elseif($_POST['curcoins'] > $coins_max) {
		echo "<br>The specified number is greater than the sum of the maximum you can currently afford.<br><a href='javascript:history.back()'>Go Back</a>";
	} else {
