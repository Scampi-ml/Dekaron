...
if($is_gm != '0') {
	if(empty($_POST['select'])) {
		echo "<center><br><form action='?do=delpshop&id=".$id."' method='POST'>
			<table class='innertab'>
				<tr>
					<td colspan='2' align='center'><img src='images/content/content_del_p_shop.png' valign='left'><br></td>
				</tr>
				<tr>
		...
		mssql_query("DELETE FROM character.dbo.user_storage WHERE character_no = '".$row2[0]."'",$ms_con);
		echo "<br><center>The characters personal shop items has been successfully cleaned out.</center>";
