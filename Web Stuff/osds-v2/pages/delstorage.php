...
if($is_gm != '0') {
	if(empty($_POST['select'])) {
		echo "<center><br><form action='?do=delstorage&id=".$id."' method='POST'>
			<table class='innertab'>
				<tr>
					<td colspan='2' align='center'><img src='images/content/content_del_storage.png' valign='left'><br></td>
				</tr>
				<tr>
		...
		echo "<br><center>The characters storage items has been successfully deleted.</center>";
