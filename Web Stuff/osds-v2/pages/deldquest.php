...
if($is_gm != '0') {
	if(empty($_POST['select'])) {
		echo "<center><br><form action='?do=deldquest&id=".$id."' method='POST'>
			<table class='innertab'>
				<tr>
					<td colspan='2' align='center'><img src='images/content/content_del_a_q.png' valign='left'><br></td>
				</tr>
				<tr>
		...
		mssql_query("DELETE FROM character.dbo.User_Quest_Doing WHERE character_no = '".$row2[0]."'",$ms_con);
		echo "<br><center>The characters On-going quest's has been successfully deleted.</center>";
