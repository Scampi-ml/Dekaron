...
?>
<div id="serverinfo">Account Login</div>
<?php

flush_this();


$query = $db_account->query("SELECT COUNT(*) AS cnt FROM USER_CONNLOG_KEY");

$row = $db_account->fetchArray($query);
...
if($count > 0){
    ...
    ORDER BY
      USER_CONNLOG_KEY.login_time ASC");
