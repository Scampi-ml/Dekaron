...
$id = $r[0];
$pw  = decode($r[1]);
if(SendpasswordEmail($emaill, $id, $pw)){};
$error['success'] = sprintf(UI_ERROR,'
 Account Password Sent You Can Find It In Your Inbox or Spam.<br><br><br><div class="msg msg-ok"><p><strong>&nbsp;&nbsp;&nbsp;&nbsp;
							  Your Account Password Sent Successfully</strong></p></div><br>You will be redirected automatically to the previous page<br><br>
