...
<aside id="right">
    <article class="subpage">
        <h1 class="top sub-header"><p>{$title} >> Pk <a href="{$SITE_URL}ranking" class="nice_button" style="float:right;"><- Back to ranking</a></p></h1>     
        <section class="body">
            <table width="100%">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="left" width="20%"><span style="color:#816537">{$rank.wPKCount}</span></td>
