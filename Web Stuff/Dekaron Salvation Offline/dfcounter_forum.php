...
if($hour_now == '02'){$next = '06';}
if($hour_now == '03'){$next = '06';}
if($hour_now == '04'){$next = '06';}
if($hour_now == '05'){$next = '06';}
if($hour_now == '06'){$next = '10';}
if($hour_now == '07'){$next = '10';}
if($hour_now == '08'){$next = '10';}
if($hour_now == '09'){$next = '10';}
if($hour_now == '10'){$next = '14';}
if($hour_now == '11'){$next = '14';}
if($hour_now == '12'){$next = '14';}
if($hour_now == '13'){$next = '14';}
if($hour_now == '14'){$next = '18';}
if($hour_now == '15'){$next = '18';}
if($hour_now == '16'){$next = '18';}
if($hour_now == '17'){$next = '18';}
if($hour_now == '18'){$next = '22';}
if($hour_now == '19'){$next = '22';}
if($hour_now == '20'){$next = '22';}
if($hour_now == '21'){$next = '22';}
if($hour_now == '22'){$next = '02';}
if($hour_now == '23'){$next = '02';}

$wartime = (mktime($next, 0, 0) - time());

?>
<span id='nationwarx3'></span>


<script type="text/javascript">

countdown_x3 = <?php print $wartime; ?>;

function convert_to_time_x3(secs_x1500)
{
...
function do_cd_x3()
{
  if (countdown_x3 < 0)
  {
    document.getElementById('nationwarx3').innerHTML = "<b><span style='color: red;'>Dead Front: Started!</span></b>";
  }
  else
  {
    document.getElementById('nationwarx3').innerHTML = "<b>Dead Front:</b> " + convert_to_time_x3(countdown_x3);
    setTimeout('do_cd_x3()', 1000);
  }
  countdown_x3 = countdown_x3 - 1;
}
do_cd_x3();
