...
if (isset($_POST) && !empty($_POST))
{
	...
	{
		$config->set( $key, $val, 'settings_account_logins' );
	}
	echo notice_message_admin('Settings successfully saved', '1', '0', 'index.php?get=module_settings&php=settings_account_logins.php');
}
else
{
?>
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_panel">
	...
	<tr class="even">
		...
		<td align="left" class="panel_text_alt2" width="45%" valign="top">
        	<input type="text" name="top" size="30" value="<?php echo htmlspecialchars($config->get('top', 'settings_account_logins')); ?>" />
        </td>
	</tr>
	<tr class="">
		<td width="45%" align="left" valign="top" class="panel_text_alt1"><b>Show null</b>
        	<br>If set to 'Yes' if will show logins that dont have a value
        </td>
		<td align="left" class="panel_text_alt2" width="45%" valign="top">
        	<select name="shownull">
			<?php 
                switch ($config->get('shownull', 'settings_account_logins'))
				{
                    case '1':
