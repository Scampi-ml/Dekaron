...
if (isset($_POST) && !empty($_POST))
{
	...
	echo notice_message_admin('Settings successfully saved', '1', '0', 'index.php?get=module_settings&php=settings_view_deleted_mails.php');
}
else
{
?>
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_panel">
	...
	<tr class="even">
		...
		<td align="left" class="panel_text_alt2" width="45%" valign="top">
        	<input type="text" name="top" size="30" value="<?php echo htmlspecialchars($config->get('top', 'settings_view_deleted_mails')); ?>" />
        </td>
	</tr>
    <tr>
