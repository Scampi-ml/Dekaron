...
<b>Guild Mark 1</b>&nbsp;&nbsp; <input name="cemblem" value="<?php echo $_GET['cemblem']; ?>" size="30">
<br>
<b>Guild Mark 2</b>&nbsp;&nbsp; <input name="cbg" value="<?php echo $_GET['cbg']; ?>" size="30">
<input type="submit" value="Create Emblem" >
<br>
<i>Copy and paste Guild Mark 1 & 2 into the edit guild form when done</i>
</form>
</body>
</html>