...
{
	$db->SQLquery("UPDATE account.dbo.USER_PROFILE SET login_tag = 'N' WHERE user_no = '%s'", $_GET['account'] );
	
	echo notice_message_admin('Account successfully banned', '1', '0', 'index.php?get=module_search_account');
}
else
{
	flush_this();
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="border">
    ...
    <tr>
        <td align="center" style="padding-top: 20px; padding-bottom: 20px;">
        	<b>Are you sure you want to ban "<?php echo $getAccountInfo['user_id']; ?>" ?</b>
            <br><br><br><br>
