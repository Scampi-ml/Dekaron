...
?>
	<div class="ui-widget">
			...
			<p>
				...
				<strong>You are searched for: find all characters with user no </strong>&quot;<?php echo $user_no; ?>&quot;
			</p>
			...
			<p>
            	...
            	<div id="dialog5" title="More info about user no seach">
            <p>
            	This page is created to seach for all accounts on a single user no that is found in the database<br />
            	This is almost the same page like the character search page.<br /><br />
                
                All of the fuctions you have there can be used here.<br />
                Note that all characters have been banned or unbanned.<br />
                This is because: when a account is banned, all of his characters are banned also.<br />
                You cant ban a single character, unless you delete that character.
            </p>
            </div>
...
<?php
 $query = "SELECT * FROM character.dbo.user_character WHERE user_no = '$user_no'";
...
<?php
						...
						echo "<center><a href='?osds=dev&page=ban_acc&user_no=".$user_no."&ban=0' id='unban-user' title='Unban'><img src='images/dev/ban.png' border='0' /></a></center>";
