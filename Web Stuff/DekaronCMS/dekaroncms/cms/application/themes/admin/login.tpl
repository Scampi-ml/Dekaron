...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Admin Login - DekaronCMS</title>
    ...
    <body class="login no-animation">
        ...
        <script>!window.jQuery && document.write(decodeURI('%3Cscript src="{$url}application/themes/admin/js/vendor/jquery-1.11.1.min.js"%3E%3C/script%3E'));</script>
