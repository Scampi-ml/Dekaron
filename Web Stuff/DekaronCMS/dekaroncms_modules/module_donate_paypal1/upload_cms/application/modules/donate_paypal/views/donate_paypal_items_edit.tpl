<div class="block block-themed themed-default">
    <div class="block-title"><h4>Edit Item</h4></div>
    <div class="block-content full">
        <form onSubmit="Donate_paypal.save(this, {$item.id}); return false" id="submit_form" class="form-horizontal">        
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input type="text" class="form-control" name="coins" id="coins" value="{$item.coins}" />
