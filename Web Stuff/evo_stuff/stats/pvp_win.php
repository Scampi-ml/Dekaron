...
<section class="main-section grid_7">
    <div class="main-content">
        <header>
            <h2>Player versus Player Win (PVP)</h2>
        </header>
        <section class="container_6 clearfix">
            <div class="grid_6">
                ...
                <table class="datatable paginate full" width="100%" align="center">
                    ...
                    <tbody>
                    <?php
						if(!$dekaron->checkForRenewal('cache/pvp_win.cache'))
						{
							include ('run_cache/run_pvp_win.php');
						}
						...
						$cached_file = file_get_contents('cache/pvp_win.cache');
                ...
                <div class="message info">Last cached at <strong><?php echo date ("F d Y H:i:s", filemtime('cache/pvp_win.cache')); ?></strong></div>
			<div>
        </section>
    </div>
</section>
