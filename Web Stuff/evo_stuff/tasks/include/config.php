...
define('TZN_DB_HOST','xxxxxxx');
define('TZN_DB_USER','xxxxxxx');       // edit here
define('TZN_DB_PASS','xxxxxxx');           // edit here
define('TZN_DB_BASE','xxxxxxx');  // edit here
define('TZN_DB_PREFIX','xxxxxxx');
define('TZN_DB_CLASS','xxxxxxx.php');
