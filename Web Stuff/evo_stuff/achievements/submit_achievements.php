 ...
 */
    ...
    */   
   define('CC_FB_TO_EMAIL', 'scampi_ml@telenet.be');
   /**
    ...
    */  
   define('CC_FB_RESULTS_REDIRECT', 'http://www.scampiml.com/evo_stuff/achievements/');
   
   /**
    * The address of the database where the form results 
    * will be saved.
    */
   define('CC_FB_DB_ADDRESS', 'xxxxxxx');
   /**
