...
$(document).ready(function() {
    ...
    $('body').append('<div class="apple_overlay" id="overlay"><iframe class="contentWrap" style="width: 100%; height: 500px"></iframe></div>');
    ...
    $('.popupballoon%20.close').click(function(){
    ...
    $('.list-view > li a:not%28.more%29').click(function(e){ e.stopPropagation(); });

    $('.preview-pane%20.preview%20.close').live('click', function(){
        $('.preview-pane .preview').animate({left: "-375px"}, 300);
