...
$INSERT[] = "INSERT INTO cache_store (cs_key, cs_value, cs_array) VALUES ('forum_cache', '', 1);";
...
$INSERT[] = "INSERT INTO cache_store (cs_key, cs_value, cs_array) VALUES ('languages', '', 1);";
...
$INSERT[] = "INSERT INTO cache_store (cs_key, cs_value, cs_array) VALUES ('components', 'a:0:{}', 1);";
...
$INSERT[] = "INSERT INTO pfields_data (pf_id, pf_title, pf_desc, pf_content, pf_type, pf_not_null, pf_member_hide, pf_max_input, pf_member_edit, pf_position, pf_show_on_reg, pf_input_format, pf_admin_only, pf_topic_format, pf_group_id, pf_icon, pf_key) VALUES (5, 'Gender', '', 'u=Not Telling|m=Male|f=Female', 'drop', 0, 0, 0, 1, 0, 0, '', 0, '', 2, '', 'gender')";
...
$INSERT[] = "INSERT INTO pfields_data (pf_id, pf_title, pf_desc, pf_content, pf_type, pf_not_null, pf_member_hide, pf_max_input, pf_member_edit, pf_position, pf_show_on_reg, pf_input_format, pf_admin_only, pf_topic_format, pf_group_id, pf_icon, pf_key) VALUES (7, 'Interests', '', '', 'textarea', 0, 0, 0, 1, 0, 0, '', 0, '', 2, '', 'interests')";
...
$INSERT[] = "SET IDENTITY_INSERT pfields_data OFF;";

$INSERT[] = "SET IDENTITY_INSERT pfields_groups ON;";
$INSERT[] = "INSERT INTO pfields_groups (pf_group_id, pf_group_name, pf_group_key) VALUES (1, 'Contact Methods', 'contact');";
$INSERT[] = "INSERT INTO pfields_groups (pf_group_id, pf_group_name, pf_group_key) VALUES (2, 'Profile Information', 'profile_info');";
$INSERT[] = "SET IDENTITY_INSERT pfields_groups OFF;";

$INSERT[] = "SET IDENTITY_INSERT core_sys_lang ON;";
$INSERT[] = "INSERT INTO core_sys_lang (lang_id, lang_short, lang_title, lang_default, lang_isrtl) VALUES (1, 'en_US', 'English (USA)', 1, 0);";
$INSERT[] = "SET IDENTITY_INSERT core_sys_lang OFF;";

$INSERT[] = "SET IDENTITY_INSERT titles ON;";
...
$INSERT[] = "SET IDENTITY_INSERT titles OFF;";

$INSERT[] = "SET IDENTITY_INSERT permission_index ON";
$INSERT[] ="INSERT INTO permission_index (perm_id, app, perm_type, perm_type_id, perm_view, perm_2, perm_3, perm_4, perm_5, perm_6, perm_7, owner_only, friend_only, authorized_users) VALUES (1, 'members', 'profile_view', 1, '*', '', '', '', '', '', '', 0, 0, NULL);";
$INSERT[] ="INSERT INTO permission_index (perm_id, app, perm_type, perm_type_id, perm_view, perm_2, perm_3, perm_4, perm_5, perm_6, perm_7, owner_only, friend_only, authorized_users) VALUES (2, 'core', 'help', 1, '*', '', '', '', '', '', '', 0, 0, NULL);";
...
$INSERT[] = "SET IDENTITY_INSERT rc_status ON";
$INSERT[] = "INSERT INTO rc_status (status, title, points_per_report, minutes_to_apoint, is_new, is_complete, is_active, rorder) VALUES(1, 'New Report', 1, 5, 1, 0, 1, 1);";
$INSERT[] = "INSERT INTO rc_status (status, title, points_per_report, minutes_to_apoint, is_new, is_complete, is_active, rorder) VALUES(2, 'Under Review', 1, 5, 0, 0, 1, 2);";
$INSERT[] = "INSERT INTO rc_status (status, title, points_per_report, minutes_to_apoint, is_new, is_complete, is_active, rorder) VALUES(3, 'Complete', 0, 0, 0, 1, 0, 3);";
$INSERT[] = "SET IDENTITY_INSERT rc_status OFF";

$INSERT[] = "SET IDENTITY_INSERT rc_status_sev ON";
$INSERT[] = "INSERT INTO rc_status_sev (id, status, points, img, is_png, width, height) VALUES (1, 1, 1, 'style_extra/report_icons/flag_gray.png', 1, 16, 16);";
$INSERT[] = "INSERT INTO rc_status_sev (id, status, points, img, is_png, width, height) VALUES (2, 1, 2, 'style_extra/report_icons/flag_blue.png', 1, 16, 16);";
$INSERT[] = "INSERT INTO rc_status_sev (id, status, points, img, is_png, width, height) VALUES (3, 1, 4, 'style_extra/report_icons/flag_green.png', 1, 16, 16);";
$INSERT[] = "INSERT INTO rc_status_sev (id, status, points, img, is_png, width, height) VALUES (4, 1, 7, 'style_extra/report_icons/flag_orange.png', 1, 16, 16);";
$INSERT[] = "INSERT INTO rc_status_sev (id, status, points, img, is_png, width, height) VALUES (5, 1, 12, 'style_extra/report_icons/flag_red.png', 1, 16, 16);";
$INSERT[] = "INSERT INTO rc_status_sev (id, status, points, img, is_png, width, height) VALUES (6, 2, 1, 'style_extra/report_icons/flag_gray_review.png', 1, 16, 16);";
$INSERT[] = "INSERT INTO rc_status_sev (id, status, points, img, is_png, width, height) VALUES (7, 3, 0, 'style_extra/report_icons/completed.png', 1, 16, 16);";
$INSERT[] = "INSERT INTO rc_status_sev (id, status, points, img, is_png, width, height) VALUES (8, 2, 2, 'style_extra/report_icons/flag_blue_review.png', 1, 16, 16);";
$INSERT[] = "INSERT INTO rc_status_sev (id, status, points, img, is_png, width, height) VALUES (9, 2, 4, 'style_extra/report_icons/flag_green_review.png', 1, 16, 16);";
$INSERT[] = "INSERT INTO rc_status_sev (id, status, points, img, is_png, width, height) VALUES (10, 2, 7, 'style_extra/report_icons/flag_orange_review.png', 1, 16, 16);";
$INSERT[] = "INSERT INTO rc_status_sev (id, status, points, img, is_png, width, height) VALUES (11, 2, 12, 'style_extra/report_icons/flag_red_review.png', 1, 16, 16);";
$INSERT[] = "SET IDENTITY_INSERT rc_status_sev OFF";


$INSERT[] = "SET IDENTITY_INSERT reputation_levels ON";
$INSERT[] = "INSERT INTO reputation_levels (level_id, level_points, level_title, level_image) VALUES(1, -20, 'Bad', '');";
$INSERT[] = "INSERT INTO reputation_levels (level_id, level_points, level_title, level_image) VALUES(2, -10, 'Poor', '');";
$INSERT[] = "INSERT INTO reputation_levels (level_id, level_points, level_title, level_image) VALUES(3, 0, 'Neutral', '');";
$INSERT[] = "INSERT INTO reputation_levels (level_id, level_points, level_title, level_image) VALUES(4, 10, 'Good', '');";
$INSERT[] = "INSERT INTO reputation_levels (level_id, level_points, level_title, level_image) VALUES(5, 20, 'Excellent', '');";
$INSERT[] = "SET IDENTITY_INSERT reputation_levels OFF";


$INSERT[] = "SET IDENTITY_INSERT core_share_links ON";
...
$INSERT[] = "INSERT INTO core_share_links (share_id, share_title, share_key, share_enabled, share_position, share_canonical ) VALUES(3, 'Digg', 'digg', 1, 3, 1);";
$INSERT[] = "INSERT INTO core_share_links (share_id, share_title, share_key, share_enabled, share_position, share_canonical ) VALUES(4, 'Del.icio.us', 'delicious', 1, 4, 1);";
$INSERT[] = "INSERT INTO core_share_links (share_id, share_title, share_key, share_enabled, share_position, share_canonical ) VALUES(5, 'Reddit', 'reddit', 1, 5, 1);";
$INSERT[] = "INSERT INTO core_share_links (share_id, share_title, share_key, share_enabled, share_position, share_canonical ) VALUES(6, 'StumbleUpon', 'stumble', 1, 6, 1);";
$INSERT[] = "INSERT INTO core_share_links (share_id, share_title, share_key, share_enabled, share_position, share_canonical ) VALUES(8, 'Email', 'email', 1, 7, 1);";
$INSERT[] = "INSERT INTO core_share_links (share_id, share_title, share_key, share_enabled, share_position, share_canonical ) VALUES(9, 'Buzz', 'buzz', 1, 3, 1);";
...
$INSERT[] = "SET IDENTITY_INSERT core_share_links OFF";