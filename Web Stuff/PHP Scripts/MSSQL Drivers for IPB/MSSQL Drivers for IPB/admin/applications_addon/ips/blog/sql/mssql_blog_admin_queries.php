...
class sql_blog_admin_queries extends db_driver_mssql
{
     protected $db  = "";
     protected $tbl = "";
   ...
   function blog_stats( $a )
    {
    	return "SELECT COUNT(*) AS num_blogs, SUM(CASE WHEN blog_view_level='public' THEN 1 ELSE 0 END) AS num_private, SUM(CASE WHEN blog_type='local' THEN 1 ELSE 0 END) AS num_local,
