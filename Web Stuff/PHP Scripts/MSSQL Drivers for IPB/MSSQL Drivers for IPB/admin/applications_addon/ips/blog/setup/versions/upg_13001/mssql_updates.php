...
$SQL[] = "CREATE TABLE blog_rsscache(
  ...
  rsscache_refresh tinyint not null default 0,
...
$SQL[] = "CREATE TABLE blog_pingservices(
  ...
  blog_service_port smallint,
  blog_service_path varchar(255) not null default '',
  blog_service_methodname varchar(255) not null default '',
  blog_service_extended tinyint not null default 0,
  blog_service_enabled tinyint not null default 0,
...
$SQL[] = "ALTER TABLE groups ADD g_blog_preventpublish TINYINT NOT NULL DEFAULT 0";
