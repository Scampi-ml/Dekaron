...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"  class="table_panel" >
	...
	if ($qnum1 == '0')
	{
		echo '<tr><td align="center" class="panel_text_alt_list" colspan="8">No storage items found</td></tr>';
	}
	else
	{
		flush_this();
	...
	?>
    <tr>
    	<td align="right" class="panel_buttons" colspan="8"><input type="submit" value="Delete Storage Item" onclick="ask_url('Are you sure you want to delete those items?','index.php?get=module_edit_storage&character=<?php echo $_GET['character']; ?>')"></td>
    </tr>
</table>
