...
if (isset($_POST) && !empty($_POST))
{
	...
	echo notice_message_admin('Settings successfully saved', '1', '0', 'index.php?get=module_settings&php=settings_edit_account.php');
}
else
{
?>
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_panel">
	...
	<tr class="even">
		...
		<td align="left" class="panel_text_alt2" width="45%" valign="top">
			...
			<?php 
                switch ($config->get('mail_table', 'settings_edit_account'))
				{
                    case 'tbl_user':
	...
	<tr class="">
		<td width="45%" align="left" valign="top" class="panel_text_alt1"><b>Update user_tbl?</b>
        	<br>If there is new data to be saved in user_profile, update user_tbl also?
            <br>(Not recommended)
        </td>
		<td align="left" class="panel_text_alt2" width="45%" valign="top">
        	<select name="mail_table">
			<?php 
                switch ($config->get('update_user_tbl', 'settings_edit_account'))
				{
                    case '1':
