<aside class="grid_1">
    <nav class="global">
		...
		if ( preg_match ( '/inventory.php/', $_SERVER["REQUEST_URI"] ) )
        {
            echo '<li class="active"><a class="nav-icon icon-database_refresh" href="inventory.php">inventory</a></li>';
        }
        else
        {
            echo '<li><a class="nav-icon icon-database_refresh" href="inventory.php">inventory</a></li>';
        }
