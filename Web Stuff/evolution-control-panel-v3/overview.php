    ...
    <div class="main-content">
        ...
        <section class="container_6 clearfix">
			...
			?>
				...
				<?php
					echo '<div class="message success"><strong>Evolution Control Panel V'.$CONFIG['UCP_VERSION'].'</strong> [ <a href="changelog.php">Changelog</a> ] |<strong> Evp Cp support</strong> [ <a href="http://evolutiongames.net/dekaron/forums/index.php?/topic/9662-evolution-control-panel/"> Visit the support topic here  </a>] | <a href="say_thanks.php">Say Thanks</a></div>';
