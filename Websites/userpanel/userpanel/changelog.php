...
<section class="main-section grid_7">
    <div class="main-content">
        ...
        <section class="container_6 clearfix">
            <div class="grid_6">
              	<fieldset>
                	<legend><font color="#CCCCCC">Version 6.0 [25 Mar 2012]</font></legend>
                	<ul>
                        <li>[ADDED] Transfer Coins, now you can send coins to your 2nd account, read the requirements!</li>
                        <li>[FIXED] D-Shop Fixes</li>
                    </ul>
                </fieldset>               
            
              	<fieldset>
                	<legend><font color="#CCCCCC">Version 5.0 [25 Mar 2012]</font></legend>
                	<ul>
                        <li>[FIXED] Gift Coins, wrong name when sending</li>
                        <li>[FIXED] Exchange Tokens, You cannot use this system if you dont have any characters</li>
                        <li>[FIXED] Friends, You cannot use this system if you dont have any characters</li>
                        <li>[FIXED] PVP, You cannot use this system if you dont have any characters</li>
                        <li>[CHANGED] Error Reporting, for better user support </li>
                    </ul>
                </fieldset>               
              	<fieldset>
                	<legend><font color="#CCCCCC">Version 4.0 [21 Mar 2012]</font></legend>
                	<ul>
                        <li>[CHANGED] Login System</li>
                        <li>[CHANGED] Logo, this is now part of the captcha system</li>  
                        <li>[ADDED] Captcha System, Drag and Drop the icon the on the evo logo</li>
                        <li>[ADDED] Brute System, People can only log into the CP 10 times per hour (per IP)</li>
                        <li>[ADDED] Login Fail System, 5 attempts per hour</li>
                        <li>[REMOVED] IF IE, internet explorer is crap and you know it !</li>
                        <li>[CHANGED] IE issues, should look better now</li>
                        <li>[FIXED] Logout, has no more white page</li>
                        <li>[FIXED] Login, image while loading the CP has been fixed with text instead of an image</li>
                        <li>[FIXED] Account Logs, Undefined variable</li>
                    </ul>
                </fieldset>              
              	<fieldset>
