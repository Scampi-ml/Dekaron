...
function RecommendGame( appid, steamworksappid, comment, divBtn, onSuccessFunc, divToShowError )
{
	$(divBtn).hide();
	new Ajax.Request( 'http://store.steampowered.com/friends/recommendgame', {
		method: 'post',
...
function InstrumentedLinkOnClick( event, link )
{
	...
	if ( navinfo )
	{
		...
		document.cookie = 'snr=' + navinfo[1] + '|' + link.href +'; expires=' + dateExpires.toGMTString() + ';path=/';		
	}
	return true;
}
