...
function UI()
{
	...
	this.initialize = function()
	{
		...
		if(Config.cookieLaw)
		{
			...
			if(!allowCookies)
			{
				UI.confirm("This website makes use of cookies to be able to keep track of who is who, and we are due to the new <a style='margin:0px;float:none;display:inline;color:green;padding:0px;' href='../www.youtube.com/watch@v=arWJA0jVPAc' target='_blank'>EU cookie law</a> forced to ask for the visitors permission to use it", "Accept", function()
				{
	...
	this.alert = function(question, time)
	{
		...
		{
			question = '<img src="img-cache.cdn.gaiaonline.com/c57f77cb596aae50b0725174b806e3ee/http_3A/i1243.photobucket.com/albums/gg544/luzcyfer/Meme/okay-meme-1.jpg" />';
		}
