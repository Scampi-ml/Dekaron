...
class M_storage extends MY_model {
	
	public function viewall()
	{
		$query = $this->db->query("SELECT * FROM user_storage WHERE character_no = '".$this->session->userdata('character_no')."' ");
		return $query->result_array();
	}
	
	public function save($line_no = '0', $byHeader = '0', $wIndex = '0', $info = '0', $exp_bindate = '0')
	{
		$data = array(
		...
		$this->db->insert('user_storage', $data); 	
	}
