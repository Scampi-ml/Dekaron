...
class M_suit extends MY_model {
	
	public function viewall()
	{
		$query = $this->db->query("SELECT * FROM user_suit WHERE character_no = '".$this->session->userdata('character_no')."' ");
