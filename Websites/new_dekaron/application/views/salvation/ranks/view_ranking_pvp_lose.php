...
<div class="container content">
  <div id="pages">
    ...
    <h2 style="text-align:center" >PVP Lose Ranking</h2>
        ...
        <table class="players-table" id="tablesort">
          <thead>
            <tr class="players-row head">
              ...
              <th class="players-cell players-cell-no-border players-align-left header">Defeats</th>
          ...
          <?php
			...
			{	
				...
				<tr>
				  ...
				  <td class="players-cell players-cell-no-border players-align-left"> '.number_format($player['wLoseRecord']).'  </td>
