...
$config['paypal_email'] 					= 'salvationdekaron.action9@gmail.com';							// Your paypal email or business 
...
// 					Unstuck Settings
//*--------------------------------------------------------
$config['unstuck_no_move'] 		= array('153'); 													// If you have a prison and you dont want to player to get out, set map IDs in this list
$config['unstuck_move_to'] 		= '182'; 															// After unstuck was valid, teleport him to this map, can be the home map (ardeca, loa, ....)
$config['unstuck_move_to_X'] 	= '39'; 															// After unstuck was valid, teleport him to X
$config['unstuck_move_to_Y'] 	= '302'; 															// After unstuck was valid, teleport him to Y
...
$config['downloads'] = array(
	array('https://drive.google.com/file/d/0BxDHZUU86q5KMGN5djRZSHh2V2s/edit?usp=sharing', 		'Google Drive', 			'downloadfile.png', 	'mirror_1'),
	array('http://www.mediafire.com/download/ygzh54bhfi2iolj/Salvation_Dekaron_Action_9.rar', 		'MediaFire', 			'downloadfile.png', 	'mirror_2'),
);
...
$config['vote_site_2'] = array('Arena Top 100',			'http://www.arena-top100.com/?ref=SalvationDK',			'115',		'43200', 		true,		true,		'arena-top100.png');
$config['vote_site_3'] = array('Xtremetop100', 			'http://www.xtremetop100.com/in.php?site=1132347217', 	'115',		'43200',		true, 		true,		'XtremeTop100.png');	
