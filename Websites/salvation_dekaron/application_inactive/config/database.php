...
$active_record = TRUE;
$db['account']['hostname'] = '37.59.180.41';
$db['account']['username'] = 'SaBaker1893';
$db['account']['password'] = 'ImPP8pL0h';
...
$active_record = TRUE;
$db['billing']['hostname'] = '37.59.180.41';
$db['billing']['username'] = 'SaBaker1893';
$db['billing']['password'] = 'ImPP8pL0h';
$db['billing']['database'] = 'billing';
$db['billing']['dbdriver'] = 'sqlsrv';
$db['billing']['dbprefix'] = '';
$db['billing']['pconnect'] = TRUE;
$db['billing']['db_debug'] = FALSE;
...
$active_group = 'cash';
$active_record = TRUE;
$db['cash']['hostname'] = '37.59.180.41';
$db['cash']['username'] = 'SaBaker1893';
$db['cash']['password'] = 'ImPP8pL0h';
$db['cash']['database'] = 'cash';
$db['cash']['dbdriver'] = 'sqlsrv';
$db['cash']['dbprefix'] = '';
$db['cash']['pconnect'] = TRUE;
$db['cash']['db_debug'] = FALSE;
...
$db['character']['hostname'] = '37.59.180.41';
$db['character']['username'] = 'SaBaker1893';
$db['character']['password'] = 'ImPP8pL0h';
$db['character']['database'] = 'character';
$db['character']['dbdriver'] = 'sqlsrv';
$db['character']['dbprefix'] = '';
$db['character']['pconnect'] = TRUE;
$db['character']['db_debug'] = FALSE;
...
$db['website']['hostname'] = '37.59.180.41';
$db['website']['username'] = 'SaBaker1893';
$db['website']['password'] = 'ImPP8pL0h';
$db['website']['database'] = 'website';
$db['website']['dbdriver'] = 'sqlsrv';
$db['website']['dbprefix'] = '';
$db['website']['pconnect'] = TRUE;
$db['website']['db_debug'] = FALSE;
