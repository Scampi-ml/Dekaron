...
<div class="container content">
  <div id="pages">
    ...
    <h2 style="text-align:center" >EXP Ranking</h2>
        ...
        <table class="players-table" id="tablesort">
          <thead>
            <tr class="players-row head">
              ...
              <th class="players-cell players-cell-no-border players-align-left header">Exp</th>
          ...
          <?php
			...
			{	
				...
				<tr>
				  ...
				  <td class="players-cell players-cell-no-border players-align-left"> '.number_format($player['dwExp']).'  </td>
				  <td class="players-cell players-cell-no-border players-align-left"> '.number_format($player['wLevel']).'  </td>
