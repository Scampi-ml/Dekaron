...
function convert_to_time_x1501 ( )
{
	secs_x1500 = countdown_x1501;
	...
	else
	{
 	...
 	countdown_x1501--;
	$("#nationwarx1501").html(ret);
}

function convert_to_time_x1502 ( )
{
	secs_x1500 = countdown_x1502;
...
$(document).ready(function()
{
	...
	setInterval('convert_to_time_x1501()', 1000);
	setInterval('convert_to_time_x1502()', 1000);
