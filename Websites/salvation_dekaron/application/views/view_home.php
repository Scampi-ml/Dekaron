...
<script type="text/javascript">countdown_x1501 = '<?php print $this->config->item('battle_time'); ?>';</script> 
<script type="text/javascript">countdown_x1502 = '<?php print $this->config->item('party_time'); ?>';</script>  
  ...
  <div class="row clearfix">
    <div class="content-left">
      ...
      <section class="ui-tabs ui-widget ui-widget-content ui-corner-all" id="news">
		...
		<div class="ui-tabs-panel ui-widget-content ui-corner-bottom" id="news-1"><?php echo $template['forums_all']; ?></span></div>    
        <div class="ui-tabs-panel ui-widget-content ui-corner-bottom" id="news-2"><?php echo $template['forums_news']; ?></span></div>  
        <div class="ui-tabs-panel ui-widget-content ui-corner-bottom" id="news-3"><?php echo $template['forums_event']; ?></span></div>  
        <div class="ui-tabs-panel ui-widget-content ui-corner-bottom" id="news-4"><?php echo $template['forums_notice']; ?></span></div>  
        <div class="ui-tabs-panel ui-widget-content ui-corner-bottom" id="news-5"><?php echo $template['forums_update']; ?></span></div>      
      </section>
    </div>
      ...
      <section id="server-status">
        <div class="server-status-inner">
          ...
          <section id="server-info-container">
              <?php echo $template['deadfront']; ?><br>
              <?php echo $template['party']; ?><br>
              <?php echo $template['battle']; ?><br>
          </section>
	...
	<a href="http://www.xtremetop100.com/in.php?site=1132347217">
