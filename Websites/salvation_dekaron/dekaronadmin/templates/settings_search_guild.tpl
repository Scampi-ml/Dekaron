...
<tr class="even">
<td width="45%" align="left" valign="top" class="panel_text_alt1"><b>Mastercode</b><br>If set to 'yes' it will show the guild master code, this is not recommended</td>
<td align="left" class="panel_text_alt2" width="45%" valign="top"><select name="mastercode">{$switch}</select></td>
</tr>
<tr class="">
