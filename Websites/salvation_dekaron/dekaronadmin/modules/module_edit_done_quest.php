...
if (isset($_POST) && !empty($_POST))
{
	...
	$POST = notice_message_admin('Done quests successfully deleted', '1', '0', 'index.php?get=module_edit_done_quest&character='.$_POST['character'].'');
}
else
{
	...
	if ($qnum1 == '0')
	{
		$table .= '<tr><td align="center" class="panel_text_alt_list" colspan="3">No quests found</td></tr>';
	}
	else
	{
