...
if (isset($_POST) && !empty($_POST))
{
	...
	$POST = notice_message_admin('Storage item successfully deleted', '1', '0', 'index.php?get=module_edit_storage&character='.$_POST['character'].'');
}
else
{
	$table = '';
	...
	if ($qnum1 == '0')
	{
		$table .= '<tr><td align="center" class="panel_text_alt_list" colspan="8">No storage items found</td></tr>';
	}
	else
	{
