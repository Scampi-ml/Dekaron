...
<link rel="stylesheet" type="text/css" href="../style/error.css" />
    ...
    <body>
        <div align="left">
			...
			{	
				echo "<h3>MD5 password</h3><br><input type='text' size='35' value='".md5($_POST['md5'])."'><br><br>Copy and paste this in the edit account form<br><small>You can close this window now.</small><br>";
			}
			else
			{
			?>
